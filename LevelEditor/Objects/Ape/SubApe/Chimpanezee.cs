...
{
    internal sealed class Chimpanezee : IMoveable, IAttacker, IEscape, ICollide, IActor, IGameObject, ILoader, ISaver
    {
        ...
        public Chimpanezee(Mesh m, Terrain terrain, Silverback silverBack, Scene scene, ref Random rand)
        {
            IsApe = true;
        ...
        public void Update(GameTime gameTime)
        {
            ...
            /*
            else if (mClosestFiend != null && mClosestFiend.IActor is IAttacker)
            {
                var lastEnemyPos = mClosestFiend.ModelMatrix.Translation;
                SetTarget(lastEnemyPos);
                mClosestFiend = null;
            }
            */
        ...
        public void Attack()
        {
            ...
            {
                //Probs not needed v
                //SetTarget(Actor.ModelMatrix.Translation);
