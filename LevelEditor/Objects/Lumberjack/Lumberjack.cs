...
{
    class Lumberjack : IMoveable, IAttacker, IEscape, ICollide, IActor, IGameObject
    {
        ...
        public Lumberjack(Mesh m, Terrain terrain, QuadTree<Actor> quadTree, Vector3 hutPosition, float innerRange, float outerRange, Scene scene, Silverback silver)
        {
            IsApe = false;
			...
			mIsAttacked = false;
			mTimeHighlighted = 0;           mHutPosition = hutPosition;
        ...
        public void Attack()
        {
            ...
            foreach (var elem in mInRangeActors)
            {
                ...
                else
                {
                    ...
                    {
                        mClosestAngle = 0.0f;
                        mClosestFiend = mSilverback.Actor;
                        break;
                    }
                    else
                    {
